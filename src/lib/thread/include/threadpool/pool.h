...
namespace shadow {
    namespace threadpool {
        ...
        public:
            ...
            auto AddTask(std::string &, F &&f, Args &&... args)->std::future<typename std::result_of<F(Args...)>::type>;
        ...
        template<class F, class... Args>
        auto Pool::AddTask(std::string &reason, F &&f, Args &&... args)->std::future<typename std::result_of<F(Args...)>::type> {
